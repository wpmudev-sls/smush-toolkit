 ...
 * @package shush_toolkit/Core/Utils
 */

// Only if required.
if ( ! function_exists( 'shush_toolkit_autoloader' ) ) {
	/**
	 * Dynamically loads the class attempting to be instantiated elsewhere in the
	 * plugin by looking at the $class_name parameter being passed as an argument.
	 *
	 * The argument should be in the form: shush_toolkit\Namespace. The
	 ...
	 * @since 1.0.0
	 */
	function shush_toolkit_autoloader( $class_name ) {
		// If the specified $class_name does not include our namespace, duck out.
		if ( false === strpos( $class_name, 'shush_toolkit' ) ) {
			return;
		}
 ...
 */
spl_autoload_register( 'shush_toolkit_autoloader' );
